...
.center-welcome { display: flex; flex-direction: column; align-items: center; justify-content: center; height: 89vh; width: 100%; }
.big-btn button { background: linear-gradient(135deg, #2563eb, #1d4ed8) !important; color: white !important; border-radius: 12px !important; padding: 18px 50px !important; font-size: 26px !important; font-weight: 700 !important; box-shadow: 0 4px 18px rgba(37,99,235,0.13); margin-top: 34px; border: none !important; }
.big-btn button:hover { background: linear-gradient(135deg, #1d4ed8, #2563eb) !important; transform: scale(1.07); }
div[data-testid="stExpander"] { background: linear-gradient(145deg, #f8fbff, #e6f0ff); border: 1px solid #bfdbfe; border-radius: 15px; box-shadow: 0 6px 12px rgba(37,99,235,0.1); margin-bottom: 15px; overflow: hidden; }
div[data-testid="stExpander"] div[role="button"] { background: linear-gradient(135deg, #60a5fa, #3b82f6); border-radius: 15px 15px 0 0; color: white !important; font-weight: 600; padding: 14px 18px !important; font-size: 17px; }
div[data-testid="stExpander"] p { color: #1e293b; }
